...
// Validate checks the field values on JwtLocation with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *JwtLocation) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on JwtLocation with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in JwtLocationMultiError, or
// nil if none found.
func (m *JwtLocation) ValidateAll() error {
	return m.validate(true)
}

func (m *JwtLocation) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	switch v := m.In.(type) {
	case *JwtLocation_Header:
		if v == nil {
			err := JwtLocationValidationError{
				field:  "In",
	...
	if len(errors) > 0 {
		return JwtLocationMultiError(errors)
	}

	return nil
}

// JwtLocationMultiError is an error wrapping multiple validation errors
// returned by JwtLocation.ValidateAll() if the designated constraints aren't met.
type JwtLocationMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m JwtLocationMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m JwtLocationMultiError) AllErrors() []error { return m }

// JwtLocationValidationError is the validation error returned by
// JwtLocation.Validate if the designated constraints aren't met.
type JwtLocationValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e JwtLocationValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e JwtLocationValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e JwtLocationValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e JwtLocationValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e JwtLocationValidationError) ErrorName() string { return "JwtLocationValidationError" }

// Error satisfies the builtin error interface
func (e JwtLocationValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = JwtLocationValidationError{}
...
func (m *AuthProvider) validate(all bool) error {
	...
	for idx, item := range m.GetJwtLocations() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, AuthProviderValidationError{
						field:  fmt.Sprintf("JwtLocations[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
			...
			if err := v.Validate(); err != nil {
				return AuthProviderValidationError{
					field:  fmt.Sprintf("JwtLocations[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
